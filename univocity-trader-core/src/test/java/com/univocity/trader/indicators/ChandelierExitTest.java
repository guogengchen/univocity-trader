...
public class ChandelierExitTest {
    ...
    public void testExitLong() {
        double[] expected =
            new double[] {44.9853, 45.0162, 44.9590, 44.9852, 45.1221, 45.1937, 45.2549, 45.2459, 45.0187, 44.7890};
    ...
    public void testExitShort() {
        double[] expected =
            new double[] {45.3246, 45.3437, 45.3309, 45.3547, 45.3978, 45.3762, 45.4450, 45.5040, 45.3912, 44.9909};
