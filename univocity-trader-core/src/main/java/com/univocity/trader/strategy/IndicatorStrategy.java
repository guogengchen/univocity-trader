...
/**
 * A {@link Strategy} that uses any {@link Indicator} implementation (usually from package
...
public abstract class IndicatorStrategy extends IndicatorGroup implements Strategy {
    ...
    /**
     * Submits the latest price update of a symbol to this strategy and all of its indicators, in order to update their
     * state
