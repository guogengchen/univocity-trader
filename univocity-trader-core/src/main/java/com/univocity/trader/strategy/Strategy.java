...
/**
 * A {@code Strategy} is responsible for processing price updates transmitted by an
 * {@link com.univocity.trader.Exchange}
 ...
 *
 * {@code Strategy} implementations that make use of any {@link Indicator} implementation in package
 * {@link com.univocity.trader.indicators}
...
public interface Strategy {
     ...
     *
     * @return an indication to {@code BUY}, {@code SELL} or do nothing (i.e. {@code NEUTRAL}). Any other value will be
     *         ignored by the
     ...
     * When {@link #getSignal(Candle)} produces a {@code BUY}, and the trade side returned by this method is
     * {@code null},
     ...
     *
     * If the signals produced by this strategy only apply to {@code LONG} or {@code SHORT} positions, the
     * {@code tradeSide}
     * method must return which side to work with.
     *
     * This method is only relevant if shorting is enabled in the account (i.e.
     * {@link AccountConfiguration#shortingEnabled()}).
     *
