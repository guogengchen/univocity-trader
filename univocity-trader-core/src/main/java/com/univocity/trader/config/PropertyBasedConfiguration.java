...
public class PropertyBasedConfiguration {
     ...
     *
     * @return the property value, if present in the configuration, or the default value in case the property doesn't
     *         exist.
     */
     ...
     * {@code getProperty("my.property", "batch", "1234", "date", "2015-DEC-25");} the result will be
     * {@code "/tmp/1234/2015-DEC-25/"}
     *
     * @param property      the property name
     ...
     * @param create        A flag indicating whether the directory must be created if it doesn't exist. In case the
     *                      path
     *                      contains a directory that doesn't exist, the parent directory will be created as well.
     *                      An {@link IllegalConfigurationException} will be thrown if the directory couldn't be
     *                      created.
     *
    ...
    /**
     * Returns an optional {@code LinkedHashSet} of values associated with a property in the configuration, if it is
     * present.
     * Assumes the values are separated by comma.
     *
     * @param property the property name
    ...
    /**
     * Returns an optional {@code List} of values associated with a property in the configuration, if the property
     * exists.
     *
     * @param property  the property name
