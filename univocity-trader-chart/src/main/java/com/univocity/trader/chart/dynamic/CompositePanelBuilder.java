...
public class CompositePanelBuilder {
    ...
    private void mergeBoundFields(Object o) {
        ...
        for (Method setter : setters) {
            ...
            if (isSetterShared(setter, o)) {
                ...
                log.debug(
                    "Setter " + setter.getName() + " being shared with the following objects " + sharedFieldSources);
            } else {
    ...
    private void mergeFields(Object observedObject) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (observedObject.getClass().getAnnotation(UIBoundClass.class) != null) {
            ...
            List<Field> fields =
                AnnotationHelper.getAnnotatedFields(observedObject.getClass(), ControllerContainer.class);
    ...
    private Set<UpdateProcessor> createMergedProcessor(Set<Object> toMerge) throws InstantiationException,
        ...
        for (Object o : toMerge) {
            ...
            UpdateProcessor processor =
                (UpdateProcessor)annotation.updateProcessor().getConstructors()[0].newInstance(o);
