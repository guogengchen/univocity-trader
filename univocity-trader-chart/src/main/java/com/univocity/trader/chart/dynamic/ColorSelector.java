    ...
    public ColorSelector(final Color initialColor, final String colorChooserTitle) {
        ...
        addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {
                // Color selectedColor = JColorChooser.showDialog(parent == null ? ColorSelector.this : parent,
                // colorChooserTitle, getSelectedColor());
                Color selectedColor =
                    WindowUtils.displayJColorChooser(ColorSelector.this, colorChooserTitle, getSelectedColor());
