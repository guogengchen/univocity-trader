...
public class BinanceApiAsyncRestClientImpl implements BinanceApiAsyncRestClient {
    ...
    public BinanceApiAsyncRestClientImpl(String apiKey, String secret, AsyncHttpClient client) {
        binanceApiService = createService(BinanceApiService.class, client, apiKey, secret);
    }
    ...
    public void getMyTrades(String symbol, Integer limit, BinanceApiCallback<List<Trade>> callback) {
        getMyTrades(symbol, limit, null, BinanceApiConstants.DEFAULT_RECEIVING_WINDOW, System.currentTimeMillis(),
            callback);
    }
    ...
    public void withdraw(String asset, String address, String amount, String name, String addressTag,
        ...
        binanceApiService
            .withdraw(asset, address, amount, name, addressTag, BinanceApiConstants.DEFAULT_RECEIVING_WINDOW,
